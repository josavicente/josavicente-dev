...
---
Segunda parte de esta serie de cuatro sobre métricas. Hoy repasamos DORA, probablemente el marco más conocido.

DORA proviene de las siglas DevOps Research Assessment, en el conocido libro **[Accelerate](https://amzn.to/3CPacnR)** se detalla un estudio realizado sobre 25mil 
...
Como decía en el post anterior, mi approach hacia las métricas se enfoca en la parte accionable a nivel de carrera y de rumbo del equipo, por tanto si bien las 4 
métricas pueden dar una visión bastante positiva de como funcionan los equipos a nivel de delivery, en mi opinión está muy centrada en el output y en la cantidad. 
Me quedo con las 24 capacidades como una lista de aspectos útiles, pero como en todo, el contexto es necesario y si bien pueden aplicar en muchos, no tiene porque hacerlo en todos.
